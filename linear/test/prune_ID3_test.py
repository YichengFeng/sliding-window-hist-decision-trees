...
f = TFile.Open("../data/TestLinearData.root")
t = f.Get("DataTTree")
...
def main():
	...
	leg = TLegend(0.45, 0.7, 0.95, 0.95)
	leg.SetFillStyle(0)
	leg.SetBorderSize(0)
	...
	cvar1.SaveAs("./plot/LinearPrune.pdf")

	dividers = cal_divider(ID3_tree, cvar1)
	for line in dividers:
		line.Draw()
	cvar1.SaveAs("./plot/LinearPruneDivide.pdf")
