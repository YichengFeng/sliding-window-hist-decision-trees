...
f = TFile.Open("../../../data/TrainNonlinearData.root")
t = f.Get("DataTTree")
...
#fullnodeslist = find_nodes_list(events)

#nodes_storage = []
#ances_node = []
#build_ID3_tree(events, nodes_storage, ances_node, fulllist, fullnodeslist)

#bcl2 = bin_combinations(events[0].var2)
#centroid0 = find_centroid(events, 0, fulllist)
#centroid1 = find_centroid(events, 1, fulllist)

#fbsn = find_best_split_node(events, -1, fulllist, fullnodeslist)
#print(fbsn.plane)
#print(fbsn.index)
#print(fbsn.varid)
#print(fullnodeslist[fbsn.index].bins)

#splist = find_split_points(events, bcl2[3], fulllist, 2)
#print(splist)
#compact_splist = []
#for i in range(len(splist) - addition_sp):
#	compact_splist.append(splist[i])
#print(compact_splist)
#plane_para = cal_split_plane(events, compact_splist, bcl2[3], 2)
#print(plane_para)

#bpp = find_best_plane(events, splist, bcl2[3], fulllist, 2)
#print(average_sub_entropy(events, bpp, fulllist, 2))
#cpp = cal_split_plane(events, compact_splist, bcl2[3], 2)
#print(average_sub_entropy(events, cpp, fulllist, 2))


#print( bcl2 )
#print( centroid0.var2 )
#print( centroid1.var2 )
#print( point_point_dist(events[0].var2, centroid0.var2, bcl2[3]) )
